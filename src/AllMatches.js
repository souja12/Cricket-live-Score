...
export default function AllMatches(fetchData, data) {
  const [dataa, setDataa] = useState([]);
  fetchData = async () => {
    const res = await fetch(
      "https://api.cricapi.com/v1/matches?apikey=5170ae7b-9565-4775-9d51-79471ee58e9a&offset=0"
    );
                  ...
                  <div className="score-card-inner flex-grow-1 px-20 py-20">
                    <div className="score-card-header mb-15">
                      <strong className="text-red">
                        Match Will Start On &nbsp;
                        {new Date(value.dateTimeGMT).toDateString()}
                      </strong>
